...
if(noisetype=="extreme"){
  risk_left<-Af$risk_xleft
  risk_right<-Af$risk_xright
}

if(noisetype=="moderate"){
  risk_left<-Af$risk_mleft
  risk_right<-Af$risk_mright
}

plot(Af$d,risk_left,xlim=range(Af$d),ylim=c(0,1),type="b",col="red",
     xlab="d",ylab="Extinction risk",cex.lab=1.5,cex.axis=1.5)
lines(Af$d,risk_right,type="b",col="blue")

mtext(paste0("r = ", round(rlist[1],5)))

plot(Al$d,risk_left,xlim=range(Al$d),ylim=c(0,1),type="b",col="red",
     xlab="d",ylab="Extinction risk",cex.lab=1.5,cex.axis=1.5)
lines(Al$d,risk_right,type="b",col="blue")
