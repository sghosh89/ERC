...
moderate right-tail association in the vital rates. Both copulae had the same Kendall 
...
same Kendall's correlation ($\tau =$ `r ktau_common`). Entries within each column of
