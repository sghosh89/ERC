...
\caption{Effect of non-Normal environmental noise copula on extinction risk after 25 years; Ricker model with local dispersion; numlocs=5, numsteps=25, numsims=10000, scl=1 \label{fig_ricker_risk_local_disp_scl_1}}
\end{center}
\end{figure}

<!--Ricker model, global dispersal-->
\begin{figure}[!h]
\begin{center}
\includegraphics[width=12 cm]{./Results/common_legend.pdf}\\
\includegraphics[width=12 cm]{./Results/ricker_scl_1/ricker_ext_risk_global_disp.pdf}\\
\caption{Effect of non-Normal environmental noise copula on extinction risk after 25 years; Ricker model with global dispersion; numlocs=5, numsteps=25, numsims=10000, scl=1 \label{fig_ricker_risk_global_disp_scl_1}}
\end{center}
\end{figure}

<!--Hassell model, local dispersal-->
\begin{figure}[!h]
\begin{center}
\includegraphics[width=12 cm]{./Results/common_legend.pdf}\\
\includegraphics[width=12 cm]{./Results/hassell_scl_1/hassell_ext_risk_local_disp.pdf}\\
\caption{Effect of non-Normal environmental noise copula on extinction risk after 25 years; Hassell model with local dispersion; numlocs=5, numsteps=25, numsims=10000, scl=1 \label{fig_hassell_risk_local_disp_scl_1}}
\end{center}
\end{figure}

<!--Hassell model, global dispersal-->
\begin{figure}[!h]
\begin{center}
\includegraphics[width=12 cm]{./Results/common_legend.pdf}\\
\includegraphics[width=12 cm]{./Results/hassell_scl_1/hassell_ext_risk_global_disp.pdf}\\
\caption{Effect of non-Normal environmental noise copula on extinction risk after 25 years; Hassell model with global dispersion; numlocs=5, numsteps=25, numsims=10000, scl=1 \label{fig_hassell_risk_global_disp_scl_1}}
\end{center}
\end{figure}

<!--Maynard smith model, local dispersal-->
\begin{figure}[!h]
\begin{center}
\includegraphics[width=12 cm]{./Results/common_legend.pdf}\\
\includegraphics[width=12 cm]{./Results/msmith_scl_0.8/msmith_ext_risk_local_disp.pdf}\\
\caption{Effect of non-Normal environmental noise copula on extinction risk after 25 years; Maynard Smith model with local dispersion; numlocs=5, numsteps=25, numsims=10000, scl=0.8. \label{fig_msmith_risk_local_disp_scl_0.8}}
\end{center}
\end{figure}

<!--Maynard smith model, global dispersal-->
\begin{figure}[!h]
\begin{center}
\includegraphics[width=12 cm]{./Results/common_legend.pdf}\\
\includegraphics[width=12 cm]{./Results/msmith_scl_0.8/msmith_ext_risk_global_disp.pdf}\\
\caption{Effect of non-Normal environmental noise copula on extinction risk after 25 years; Maynard Smith model with global dispersion; numlocs=5, numsteps=25, numsims=10000, scl=0.8. \label{fig_msmith_risk_global_disp_scl_0.8}}
\end{center}
\end{figure}

<!--Pennycuick model, local dispersal-->
\begin{figure}[!h]
\begin{center}
\includegraphics[width=12 cm]{./Results/common_legend.pdf}\\
\includegraphics[width=12 cm]{./Results/pennycuick_scl_1/pennycuick_ext_risk_local_disp.pdf}\\
\caption{Effect of non-Normal environmental noise copula on extinction risk after 25 years; Pennycuick model with local dispersion; numlocs=5, numsteps=25, numsims=10000, scl=1. \label{fig_risk_local_disp_pennycuick_r_vary_scl_1}}
\end{center}
\end{figure}

<!--Pennycuick model, global dispersal-->
\begin{figure}[!h]
\begin{center}
\includegraphics[width=12 cm]{./Results/common_legend.pdf}\\
\includegraphics[width=12 cm]{./Results/pennycuick_scl_1/pennycuick_ext_risk_global_disp.pdf}\\
\caption{Effect of non-Normal environmental noise copula on extinction risk after 25 years; Pennycuick model with global dispersion; numlocs=5, numsteps=25, numsims=10000, scl=1. \label{fig_risk_global_disp_pennycuick_r_vary_scl_1}}
\end{center}
\end{figure}

<!--Verhulst model, local dispersal-->
\begin{figure}[!h]
\begin{center}
\includegraphics[width=12 cm]{./Results/common_legend.pdf}\\
\includegraphics[width=12 cm]{./Results/verhulst_scl_0.6/verhulst_ext_risk_local_disp.pdf}\\
\caption{Effect of non-Normal environmental noise copula on extinction risk after 25 years; Verhulst model with local dispersion; numlocs=5, numsteps=25, numsims=10000, scl=0.6. \label{fig_risk_local_disp_verhulst_r_vary_scl_0.6}}
\end{center}
\end{figure}

<!--Verhulst model, global dispersal-->
\begin{figure}[!h]
\begin{center}
\includegraphics[width=12 cm]{./Results/common_legend.pdf}\\
\includegraphics[width=12 cm]{./Results/verhulst_scl_0.6/verhulst_ext_risk_global_disp.pdf}\\
\caption{Effect of non-Normal environmental noise copula on extinction risk after 25 years; Verhulst model with global dispersion; numlocs=5, numsteps=25, numsims=10000, scl=0.6. \label{fig_risk_global_disp_verhulst_r_vary_scl_0.6}}
\end{center}
\end{figure}

<!--Austin brewer model, local dispersal-->
\begin{figure}[!h]
\begin{center}
\includegraphics[width=12 cm]{./Results/common_legend.pdf}\\
\includegraphics[width=12 cm]{./Results/austinbrewer_scl_0.6/abrewer_ext_risk_local_disp.pdf}\\
\caption{Effect of non-Normal environmental noise copula on extinction risk after 25 years; Austin-Brewer model with local dispersion; numlocs=5, numsteps=25, numsims=10000, scl=0.6. \label{fig_risk_local_disp_abrewer_r_vary_scl_0.6}}
\end{center}
\end{figure}

<!--Austin brewer model, global dispersal-->
\begin{figure}[!h]
\begin{center}
\includegraphics[width=12 cm]{./Results/common_legend.pdf}\\
\includegraphics[width=12 cm]{./Results/austinbrewer_scl_0.6/abrewer_ext_risk_global_disp.pdf}\\
\caption{Effect of non-Normal environmental noise copula on extinction risk after 25 years; Austin-Brewer model with global dispersion; numlocs=5, numsteps=25, numsims=10000, scl=0.6. \label{fig_risk_global_disp_abrewer_r_vary_scl_0.6}}
\end{center}
\end{figure}
