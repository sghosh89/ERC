...
\begin{figure}[!h]
\textbf{ \hspace{6.8 cm} (A) \hspace{4.4 cm} (B)} \\
\vspace{-0.9 cm}
\begin{center}
...
\caption{Extinction risk from single patch age structured linear ($\Omega = \infty$) models, fecundity of adults and survival of eggs have either left or right tail dependence in their corresponding copula structure $(A)$ Clayton and Survival Clayton (parameter = 3), $(B)$ Survival Gumbel and Gumbel (parameter = 2.5), numsims=10000. All copula has same Kendall correlation $\tau = 0.6$. \label{fig_extrisk_agestr_C_SC_G_SG_linear}}
\end{center}
\end{figure}
