...
\caption[Extinction risk v. tail association, $d$ and $r$: metapopulations, local dispersal, Verhulst]{Analogous to Fig. \ref{MT-fig_extrisk_allmodel_localdisp} in the main text, but considering more values of $r$ and only the Verhulst model. \label{fig_risk_local_disp_verhulst_r_vary_scl_0.6}}
\end{center}
\end{figure}
