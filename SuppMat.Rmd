...
# calculate tau with sampling variation
kcor_el<-cor(xtc_l,xtc_l,method = "kendall")
kcor_el<-kcor_el[1,2]

kcor_er<-cor(xtc_r,xtc_r,method = "kendall")
kcor_er<-kcor_er[1,2]

kcor_ml<-cor(mtc_l,mtc_l,method = "kendall")
kcor_ml<-kcor_ml[1,2]

kcor_mr<-cor(mtc_r,mtc_r,method = "kendall")
kcor_mr<-kcor_mr[1,2]
```
...
# A brief introduction about "copulas"  \label{intro_copula}
