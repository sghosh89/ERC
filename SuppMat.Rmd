...
plot(0,-1,ylim=c(0,1),xlim=range(t),ylab="Extinction risk",xlab="time",cex.lab=1.5)
x<-xL
...
for(i in 1:dim(res_ricker_local)[3]){
  ...
  s<-res_ricker_local[,,i][1:6,] # plot for d in range (0 to 0.5)
  s<-as.data.frame(s)
  
  plot(s$d,s$risk_left,xlim=range(s$d),ylim=c(0,1),type="b",col="red",
       #panel.first = grid(),
...
for(i in 1:dim(res_ricker_global)[3]){
  #s<-res_ricker_global
  s<-res_ricker_global[,,i][1:6,] # plot for d in range (0 to 0.5)
  s<-as.data.frame(s)
...
for(i in 1:dim(res_hassell_local)[3]){
  s<-res_hassell_local[,,i][1:6,] # plot for d in range (0 to 0.5)
  s<-as.data.frame(s)
...
for(i in 1:dim(res_hassell_global)[3]){
  s<-res_hassell_global[,,i][1:6,] # plot for d in range (0 to 0.5)
  s<-as.data.frame(s)
...
for(i in 1:dim(res_msmith_local)[3]){
  s<-res_msmith_local[,,i][1:6,] # plot for d in range (0 to 0.5)
  s<-as.data.frame(s)
...
for(i in 1:dim(res_msmith_global)[3]){
  s<-res_msmith_global[,,i][1:6,] # plot for d in range (0 to 0.5)
  s<-as.data.frame(s)
...
for(i in 1:dim(res_pennycuick_local)[3]){
  s<-res_pennycuick_local[,,i][1:6,] # plot for d in range (0 to 0.5)
  s<-as.data.frame(s)
...
for(i in 1:dim(res_pennycuick_global)[3]){
  s<-res_pennycuick_global[,,i][1:6,] # plot for d in range (0 to 0.5)
  s<-as.data.frame(s)
...
for(i in 1:dim(res_verhulst_local)[3]){
  s<-res_verhulst_local[,,i][1:6,] # plot for d in range (0 to 0.5)
  s<-as.data.frame(s)
...
for(i in 1:dim(res_verhulst_global)[3]){
  s<-res_verhulst_global[,,i][1:6,] # plot for d in range (0 to 0.5)
  s<-as.data.frame(s)
...
for(i in 1:dim(res_abrewer_local)[3]){
  s<-res_abrewer_local[,,i][1:6,] # plot for d in range (0 to 0.5)
  s<-as.data.frame(s)
...
for(i in 1:dim(res_abrewer_global)[3]){
  s<-res_abrewer_global[,,i][1:6,] # plot for d in range (0 to 0.5)
  s<-as.data.frame(s)
...
legend("bottomright", c("Austin-Brewer",paste0("sd =",scl)), horiz=F, bty='n',cex=1.8)
par(op)
dev.off()
```
