...
xL<-las_exL$extdf[1:26,]
xR<-las_exR$extdf[1:26,]
t<-c(0:(nrow(xL)-1))
...
xL<-nlas_exL$extdf[1:26,]
xR<-nlas_exR$extdf[1:26,]
t<-c(0:(nrow(xL)-1))
...
# Vital rates in a stochastic age-structured model \label{age_str_vitalrates}
