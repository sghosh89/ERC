...
![Effect of non-Normal environmental noise copula on extinction risk after 25 years (Verhulst model : rc = 1, scl=0.6) with local dispersion; numlocs=5, numsteps=25, numsims=10000\label{fig_risk_local_disp_verhulst_r_vary_scl_0.6}](./Results/verhulst_scl_0.6/verhulst_ext_risk_local_disp.pdf){ width=40%, height=40% }

![Effect of non-Normal environmental noise copula on extinction risk after 25 years (Verhulst model : rc = 1, scl=0.6) with global dispersion; numlocs=5, numsteps=25, numsims=10000\label{fig_risk_global_disp_verhulst_r_vary_scl_0.6}](./Results/verhulst_scl_0.6/verhulst_ext_risk_global_disp.pdf){ width=40%, height=40% }

![Effect of non-Normal environmental noise copula on extinction risk after 25 years (Verhulst model with no dispersion : rc = 1, scl=0.6); numlocs=5, numsteps=25, numsims=10000\label{fig_verhulst_risk_d0_scl_0.6}](./Results/verhulst_scl_0.6/verhulst_extrisk_d0.pdf){ width=40%, height=40% }
