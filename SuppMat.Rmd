...
<!--Ricker model-->
![Effect of non-Normal environmental noise copula on extinction risk after 25 years; Ricker model with local dispersion; numlocs=5, numsteps=25, numsims=10000, scl=1 \label{fig_ricker_risk_local_disp_scl_1}](./Results/ricker_scl_1/ricker_ext_risk_local_disp.pdf){ width=40%, height=40% }

![Effect of non-Normal environmental noise copula on extinction risk after 25 years ; Ricker model with global dispersion; numlocs=5, numsteps=25, numsims=10000, scl=1 \label{fig_ricker_risk_global_disp_scl_1}](./Results/ricker_scl_1/ricker_ext_risk_global_disp.pdf){ width=40%, height=40% }

![Effect of non-Normal environmental noise copula on extinction risk after 25 years (ricker model with no dispersion : rc=1); numlocs=5, numsteps=25, numsims=10000, scl=1 \label{fig_ricker_risk_d0_scl_1}](./Results/ricker_scl_1/ricker_extrisk_d0.pdf){ width=40%, height=40% }

<!--Hassell model-->
![Effect of non-Normal environmental noise copula on extinction risk after 25 years (Hassell model : a = 0.5, b = 100, rc = 2.73, scl=1) with local dispersion; numlocs=5, numsteps=25, numsims=10000\label{fig_risk_local_disp_hassell_scl_1}](./Results/hassell_scl_1/hassell_ext_risk_local_disp.pdf){ width=40%, height=40% }

![Effect of non-Normal environmental noise copula on extinction risk after 25 years (Hassell model : a = 0.5, b = 100, rc = 2.73, scl=1) with global dispersion; numlocs=5, numsteps=25, numsims=10000\label{fig_risk_global_disp_hassell_scl_1}](./Results/hassell_scl_1/hassell_ext_risk_global_disp.pdf){ width=40%, height=40% }

![Effect of non-Normal environmental noise copula on extinction risk after 25 years (hassell model with no dispersion : rc=2.73199, scl=1); numlocs=5, numsteps=25, numsims=10000\label{fig_hassell_risk_d0_scl_1}](./Results/hassell_scl_1/hassell_extrisk_d0.pdf){ width=40%, height=40% }
...
<!--Pennycuick model-->
![Effect of non-Normal environmental noise copula on extinction risk after 25 years (Pennycuick model : a = 0.1, b = 0.1, scl=1) with local dispersion; numlocs=5, numsteps=25, numsims=10000\label{fig_risk_local_disp_pennycuick_r_vary_scl_1}](./Results/pennycuick_scl_1/pennycuick_ext_risk_local_disp.pdf){ width=40%, height=40% }

![Effect of non-Normal environmental noise copula on extinction risk after 25 years (Pennycuick model : a = 0.1, b = 0.1, scl=1) with global dispersion; numlocs=5, numsteps=25, numsims=10000\label{fig_risk_global_disp_pennycuick_r_vary_scl_1}](./Results/pennycuick_scl_1/pennycuick_ext_risk_global_disp.pdf){ width=40%, height=40% }

![Effect of non-Normal environmental noise copula on extinction risk after 25 years (Pennycuick model with no dispersion : rc=4.3231657); numlocs=5, numsteps=25, numsims=10000, scl=1 \label{fig_pennycuick_risk_d0_scl_1}](./Results/pennycuick_scl_1/pennycuick_extrisk_d0.pdf){ width=40%, height=40% }

<!--Verhulst model-->
![Effect of non-Normal environmental noise copula on extinction risk after 25 years (Verhulst model : scl=0.6) with local dispersion; numlocs=5, numsteps=25, numsims=10000\label{fig_risk_local_disp_pennycuick_r_vary_scl_1}](./Results/verhulst_scl_0.6/verhulst_ext_risk_local_disp.pdf){ width=40%, height=40% }

![Effect of non-Normal environmental noise copula on extinction risk after 25 years (Verhulst model : scl=0.6) with global dispersion; numlocs=5, numsteps=25, numsims=10000\label{fig_risk_global_disp_pennycuick_r_vary_scl_1}](./Results/verhulst_scl_0.6/verhulst_ext_risk_global_disp.pdf){ width=40%, height=40% }

![Effect of non-Normal environmental noise copula on extinction risk after 25 years (Pennycuick model with no dispersion : rc=4.3231657); numlocs=5, numsteps=25, numsims=10000, scl=1 \label{fig_pennycuick_risk_d0_scl_1}](./Results/pennycuick_scl_1/pennycuick_extrisk_d0.pdf){ width=40%, height=40% }

<!--Austin brewer model-->
![Effect of non-Normal environmental noise copula on extinction risk after 25 years (Austin Brewer model : K = 50, s = 0.2, rc = 0.02000091, scl=0.6) with local dispersion; numlocs=5, numsteps=25, numsims=10000\label{fig_risk_local_disp_abrewer_r_vary_scl_0.6}](./Results/austinbrewer_scl_0.6/abrewer_ext_risk_local_disp.pdf){ width=40%, height=40% }

![Effect of non-Normal environmental noise copula on extinction risk after 25 years (Austin Brewer model : K = 50, s = 0.2, rc = 0.02000091, scl=0.6) with global dispersion; numlocs=5, numsteps=25, numsims=10000\label{fig_risk_global_disp_abrewer_r_vary_scl_0.6}](./Results/austinbrewer_scl_0.6/abrewer_ext_risk_global_disp.pdf){ width=40%, height=40% }

![Effect of non-Normal environmental noise copula on extinction risk after 25 years (Austin Brewer model with no dispersion : rc=0.02000091, scl=0.6); numlocs=5, numsteps=25, numsims=10000\label{fig_abrewer_risk_d0_scl_0.6}](./Results/austinbrewer_scl_0.6/abrewer_extrisk_d0.pdf){ width=40%, height=40% }


```{r create_maintext_fig3,echo=F,results="hide"}
...
legend(x=0.6,y=1.05, c("noise : LTdep.","noise : RTdep."), lty=c(1,1), pch=c(1,1), 
...
mtext(paste("(a = 1, b = 3, sd = 0.8)"), side = 3, line=-8.2, adj=0.6, cex=1, col="black")
x<-res_msmith_local
