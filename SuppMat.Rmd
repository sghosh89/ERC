...
abline(v=rc_ricker,lty="dotted",col="darkgrey") #rc=1
...
abline(v=rc_hassell,lty="dotted",col="darkgrey")
...
abline(v=rc_msmith,lty="dotted",col="darkgrey")
...
abline(v=rc_pennycuick,lty="dotted",col="darkgrey")
...
abline(v=rc_verhulst,lty="dotted",col="darkgrey")
...
abline(v=rc_abrewer,lty="dotted",col="darkgrey")
...
numsims=10000, $\sigma$=1. \label{fig_ricker_risk_local_disp_scl_1_etd}}
\end{center}
\end{figure}
...
numsims=10000, $\sigma$=1. \label{fig_hassell_risk_local_disp_scl_1_etd}}
\end{center}
\end{figure}
...
numsims=10000, $\sigma$=0.8. \label{fig_msmith_risk_local_disp_scl_0.8_etd}}
\end{center}
\end{figure}
...
numsims=10000, $\sigma$=1. \label{fig_risk_local_disp_pennycuick_r_vary_scl_1_etd}}
\end{center}
\end{figure}
...
numsims=10000, $\sigma$=0.6. \label{fig_risk_local_disp_verhulst_r_vary_scl_0.6_etd}}
\end{center}
\end{figure}
...
numsims=10000, $\sigma$=0.6. \label{fig_risk_local_disp_abrewer_r_vary_scl_0.6_etd}}
\end{center}
\end{figure}
...
\caption[Effect of moderate tail-dependent environmental noises on extinction risk for Ricker metapopulation model with local dispersal.]{Effect of moderate tail-dependent environmental noises on extinction risk (calculated after 25 years)
for $5$ metapopulation patches which followed Ricker dynamics with local dispersal; 
numsims=10000, $\sigma$=1. \label{fig_ricker_risk_local_disp_scl_1_mtd}}
\end{center}
\end{figure}
...
\caption[Effect of extreme tail-dependent environmental noises on extinction risk for Hassell metapopulation model with local dispersal.]{Effect of extreme tail-dependent environmental noises on extinction risk (calculated after 25 years)
for $5$ metapopulation patches which followed Hassell dynamics with local dispersal; 
numsims=10000, $\sigma$=1. \label{fig_hassell_risk_local_disp_scl_1_mtd}}
\end{center}
\end{figure}
...
\caption[Effect of extreme tail-dependent environmental noises on extinction risk for Maynard smith metapopulation model with local dispersal.]{Effect of extreme tail-dependent environmental noises on extinction risk (calculated after 25 years)
for $5$ metapopulation patches which followed Maynard Smith dynamics with local dispersal; 
numsims=10000, $\sigma$=0.8. \label{fig_msmith_risk_local_disp_scl_0.8_mtd}}
\end{center}
\end{figure}
...
\caption[Effect of extreme tail-dependent environmental noises on extinction risk for Pennycuick metapopulation model with local dispersal.]{Effect of extreme tail-dependent environmental noises on extinction risk (calculated after 25 years)
for $5$ metapopulation patches which followed Pennycuick dynamics with local dispersal; 
numsims=10000, $\sigma$=1. \label{fig_risk_local_disp_pennycuick_r_vary_scl_1_mtd}}
\end{center}
\end{figure}
...
\caption[Effect of extreme tail-dependent environmental noises on extinction risk for Verhulst metapopulation model with local dispersal.]{Effect of extreme tail-dependent environmental noises on extinction risk (calculated after 25 years)
for $5$ metapopulation patches which followed Verhulst dynamics with local dispersal; 
numsims=10000, $\sigma$=0.6. \label{fig_risk_local_disp_verhulst_r_vary_scl_0.6_mtd}}
\end{center}
\end{figure}
...
\caption[Effect of extreme tail-dependent environmental noises on extinction risk for Austin-Brewer metapopulation model with local dispersal.]{Effect of extreme tail-dependent environmental noises on extinction risk (calculated after 25 years)
for $5$ metapopulation patches which followed Austin-Brewer dynamics with local dispersal; 
numsims=10000, $\sigma$=0.6. \label{fig_risk_local_disp_abrewer_r_vary_scl_0.6_mtd}}
\end{center}
\end{figure}
=========================
...
for $5$ metapopulation patches which followed Ricker dynamics with global dispersal; 
numsims=10000, $\sigma$=1. \label{fig_ricker_risk_global_disp_scl_1_etd}}
\end{center}
\end{figure}
...
numsims=10000, $\sigma$=1. \label{fig_hassell_risk_global_disp_scl_1_etd}}
\end{center}
\end{figure}
...
numsims=10000, $\sigma$=0.8. \label{fig_msmith_risk_global_disp_scl_0.8_etd}}
\end{center}
\end{figure}
...
numsims=10000, $\sigma$=1. \label{fig_risk_global_disp_pennycuick_r_vary_scl_1_etd}}
\end{center}
\end{figure}
...
numsims=10000, $\sigma$=0.6. \label{fig_risk_global_disp_verhulst_r_vary_scl_0.6_etd}}
\end{center}
\end{figure}
...
numsims=10000, $\sigma$=0.6. \label{fig_risk_global_disp_abrewer_r_vary_scl_0.6_etd}}
\end{center}
\end{figure}
