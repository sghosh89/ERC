...
scor_er<- -scor_el # Note it should be opposite to scor_el

scor_ml<-cor(mtc_l,mtc_l,method = "spearman")
scor_ml<- scor_ml[1,2]

#scor_mr<-cor(mtc_r,mtc_r,method ="spearman")
scor_mr<- -scor_ml # Note it should be opposite to scor_ml
```
...
same Kendall's correlation ($\rho =$ `r srho_common`). Entries within each column of
...
Clayton copula with same Kendall correlation ($\rho =$ `r srho_common`) between
