---
title: "Supporting Information : Extreme climatic events with asymmetric tail-dependence affect population-extinction risk"
...
```{r fig_agestr_C_SC_G_SG_linear, echo=F,results="hide"}
xL<-C_age$extdf
xR<-SC_age$extdf
t<-c(0:(nrow(xL)-1))
...
legend("topleft", c("vital rates : LTdep., C","vital rates : RTdep., SC"), lty=c(1,1),  
       col=c('red', 'blue'), horiz=F, bty='n', cex=1.5)
par(op)
dev.off()
...
xR<-G_age$extdf
t<-c(0:(nrow(xL)-1))
pdf(paste("./Results/age_str_results/extrisk_age_str_SG_G_linear.pdf",sep=""),height=5,width=5)
op<-par(mar=c(5,4,1.5,1.5),mgp=c(2,0.7,0))
plot(0,-1,ylim=c(0,1),xlim=range(t),ylab="Extinction risk",xlab="time",cex.lab=2,cex.axis=1.5)
x<-xL
polygon(c(rev(t), t), c(rev(x$CI0.975), x$CI0.025), col = rgb(1,0,0,0.3), border = NA)
...
polygon(c(rev(t), t), c(rev(x$CI0.975), x$CI0.025), col = rgb(0,0,1,0.3), border = NA)
lines(t,x$erA,col="blue",type="l")
legend("topleft", c("vital rates : LTdep., SG","vital rates : RTdep., G"), lty=c(1,1),  
       col=c('red', 'blue'), horiz=F, bty='n', cex=1.5)
par(op)
dev.off()
```

```{r sim_nonlinear_C_SC_G_SG, echo=F,  cache=T, cache.extra=list(seed,mtime("ext_risk_cop_age_str.R"))}
set.seed(seed)
source("ext_risk_cop_age_str.R")
...
```{r fig_agestr_C_SC_G_SG_nonlinear, echo=F,results="hide"}
xL<-C_age$extdf
xR<-SC_age$extdf
t<-c(0:(nrow(xL)-1))
...
xL<-SG_age$extdf[1:26,]
xR<-G_age$extdf[1:26,]
t<-c(0:(nrow(xL)-1))
pdf(paste("./Results/age_str_results/extrisk_age_str_SG_G_nonlinear_omg_",omg,".pdf",sep=""),height=5,width=5)
op<-par(mar=c(5,4,1.5,1.5),mgp=c(2,0.7,0))
plot(0,-1,ylim=c(0,1),xlim=range(t),ylab="Extinction risk",xlab="time",cex.lab=2,cex.axis=1.5)
x<-xL
polygon(c(rev(t), t), c(rev(x$CI0.975), x$CI0.025), col = rgb(1,0,0,0.3), border = NA)
...
polygon(c(rev(t), t), c(rev(x$CI0.975), x$CI0.025), col = rgb(0,0,1,0.3), border = NA)
lines(t,x$erA,col="blue",type="l")
legend("topleft", c("vital rates : LTdep.","vital rates : RTdep."), lty=c(1,1),  
       col=c('red', 'blue'), horiz=F, bty='n', cex=1.5)
par(op)
dev.off()
```
...
for(i in c(1:length(rlist))){
    ...
    temp_mat<-cbind(ss$d_seq,ss$risk_left,ss$risk_right,ss$pop_avg_acf_left,ss$pop_avg_acf_right)
    res_ricker_local<-abind(res_ricker_local,temp_mat,along = 3)
      
    ricker_extrisk_d0$risk_left_d0[i]<-ss$risk_left[1]
    ricker_extrisk_d0$risk_right_d0[i]<-ss$risk_right[1]
}
...
pdf("./Results/common_legend.pdf",height=1,width=12)
op<-par(fig = c(0, 1, 0, 1), oma = c(0, 0, 0, 0), mar = c(0, 0, 0, 0))
plot(0, 0, type = "n", bty = "n", xaxt = "n", yaxt = "n")
legend("center", c("noise : LTdep.","noise : RTdep."), lty=c(1,1), pch=c(1,1), 
...
for(i in 1:dim(res_ricker_local)[3]){
  ...
  plot(ss$d,ss$risk_left,xlim=range(ss$d),ylim=c(0,1),type="b",col="red",
       #panel.first = grid(),
       xlab="d",ylab="Extinction risk",cex.lab=2,cex.axis=1.5)
  lines(ss$d,ss$risk_right,type="b",col="blue")
  ...
  #plot(ss$d, ss$pop_avg_acf_left, pch=16,  xlab="", ylab="", ylim=ylm2,xlim=c(0,1),
       #ylim=range(-0.1,0.1), xlim=c(0,1),cex.axis=1.5,bty="n",
  #     axes=FALSE, type="l", col="orange")
 # abline(h=0,lty="dotted",col="darkgrey")
 # lines(ss$d, ss$pop_avg_acf_right, col="skyblue")
...
pdf(paste(resloc,"ricker_extrisk_d0.pdf",sep=""),height=5,width=5)
op<-par(mar=c(5,4,1.5,1.5),mgp=c(2,0.7,0))
...
for(i in c(1:length(rlist))){
    ...
    hassell_extrisk_d0$risk_left_d0[i]<-ss$risk_left[1]
    hassell_extrisk_d0$risk_right_d0[i]<-ss$risk_right[1]
}
...
pdf(paste(resloc,"hassell_extrisk_d0.pdf",sep=""),height=5,width=5)
op<-par(mar=c(5,4,1.5,1.5),mgp=c(2,0.7,0))
...
for(i in c(1:length(rlist))){
    ...
    msmith_extrisk_d0$risk_left_d0[i]<-ss$risk_left[1]
    msmith_extrisk_d0$risk_right_d0[i]<-ss$risk_right[1]
}
...
pdf(paste(resloc,"msmith_extrisk_d0.pdf",sep=""),height=5,width=5)
op<-par(mar=c(5,4,1.5,1.5),mgp=c(2,0.7,0))
...
for(i in c(1:length(rlist))){
    ...
    pennycuick_extrisk_d0$risk_left_d0[i]<-ss$risk_left[1]
    pennycuick_extrisk_d0$risk_right_d0[i]<-ss$risk_right[1]
}
anm<-paste("r_",rlist,sep="")
cnm<-c("d","risk_left","risk_right","pop_avg_acf_left","pop_avg_acf_right")
...
pdf(paste(resloc,"pennycuick_ext_risk_local_disp.pdf",sep=""),height=12,width=12)
...
pdf(paste(resloc,"pennycuick_ext_risk_global_disp.pdf",sep=""),height=12,width=12)
op<-par(mfrow=c(4,4),mar=c(5,4,1.5,1.5),mgp=c(2,0.5,0))
...
pdf(paste(resloc,"pennycuick_extrisk_d0.pdf",sep=""),height=5,width=5)
op<-par(mar=c(5,4,1.5,1.5),mgp=c(2,0.7,0))
...
for(i in c(1:length(rlist))){
    ...
    verhulst_extrisk_d0$risk_left_d0[i]<-ss$risk_left[1]
    verhulst_extrisk_d0$risk_right_d0[i]<-ss$risk_right[1]
}
...
pdf(paste(resloc,"verhulst_extrisk_d0.pdf",sep=""),height=5,width=5)
op<-par(mar=c(5,4,1.5,1.5),mgp=c(2,0.7,0))
...
for(i in c(1:length(rlist))){
  ...
  abrewer_extrisk_d0$risk_left_d0[i]<-ss$risk_left[1]
  abrewer_extrisk_d0$risk_right_d0[i]<-ss$risk_right[1]
}
...
pdf(paste(resloc,"abrewer_extrisk_d0.pdf",sep=""),height=5,width=5)
op<-par(mar=c(5,4,1.5,1.5),mgp=c(2,0.7,0))
...
getplot<-function(x,rlist){
lasta<-dim(x)[3]
Af<-as.data.frame(x[,,1][1:6,])
Al<-as.data.frame(x[,,lasta][1:6,])

plot(Af$d,Af$risk_left,xlim=range(Af$d),ylim=c(0,1),type="b",col="red",
       #panel.first = grid(),
     xlab="d",ylab="Extinction risk",cex.lab=1.5,cex.axis=1.5)
lines(Af$d,Af$risk_right,type="b",col="blue")

mtext(paste0("r = ", round(rlist[1],5)))

plot(Al$d,Al$risk_left,xlim=range(Al$d),ylim=c(0,1),type="b",col="red",
       #panel.first = grid(),
     xlab="d",ylab="Extinction risk",cex.lab=1.5,cex.axis=1.5)
lines(Al$d,Al$risk_right,type="b",col="blue")
mtext(paste0("r = ", round(rlist[lasta],5)))

}

pdf("./Results/allmodel_ext_risk_local_disp.pdf",height=12,width=9)
...
legend(x=0.7,y=1.05, c("noise : LTdep.","noise : RTdep."), lty=c(1,1), pch=c(1,1), 
       col=c('red', 'blue'), horiz=F, bty='o', cex=1.5, adj=0)
...
pdf("./Results/allmodel_ext_risk_global_disp.pdf",height=12,width=9)
...
<!--Supp. FIG :  age structure model results for C, SC, G, SG with linear model (\Omega = infinity)-->
\begin{figure}[!h]
\begin{center}
\textbf{ \hspace{0.5 cm} (A) \hspace{4.4 cm} (B)} \\
\vspace{-0.2 cm}
\includegraphics[width=5 cm]{./Results/age_str_results/extrisk_age_str_C_SC_linear.pdf}
\includegraphics[width=5 cm]{./Results/age_str_results/extrisk_age_str_SG_G_linear.pdf}\\
\textbf{ \hspace{0.5 cm} (C) \hspace{4.4 cm} (D)} \\
\vspace{-0.2 cm}
\includegraphics[width=5 cm]{./Results/age_str_results/extrisk_age_str_C_SC_nonlinear_omg_100.pdf}
\includegraphics[width=5 cm]{./Results/age_str_results/extrisk_age_str_SG_G_nonlinear_omg_100.pdf}\\
\caption[Extinction risk from single patch age structured models with time when vital rates have either left (C, SG) or right tail (SC, G) dependence.]{Extinction risk (shading represents 95\% confidence interval) from single patch age structured models with time; fecundity of adults and survival of eggs have either left or right tail dependence in their corresponding copula structure. $(A)$ Clayton and Survival Clayton (parameter = 3), $(B)$ Survival Gumbel and Gumbel (parameter = 2.5) for linear model ($\Omega = \infty$), numsims=10000. $(C - D)$ represents the analogous figures as of $(A - B)$ but for non-linear model ($\Omega = 100$). All copula has same Kendall correlation $\tau = 0.6$. \label{fig_extrisk_agestr_C_SC_G_SG_linear}}
\end{center}
\end{figure}

<!--Supp. FIG :  summary : all nonlinear model results for global dispersion : extrisk vs. d-->
\begin{figure}[!h]
\begin{center}
\includegraphics[width=15 cm]{./Results/allmodel_ext_risk_global_disp.pdf}
...
<!--Supp. FIG : Ricker model, local dispersal-->
\begin{figure}[!h]
\begin{center}
\includegraphics[width=12 cm]{./Results/common_legend.pdf}\\
\includegraphics[width=12 cm]{./Results/ricker_scl_1/ricker_ext_risk_local_disp.pdf}\\
...
numsims=10000, $\sigma$=1. \label{fig_ricker_risk_local_disp_scl_1}}
\end{center}
\end{figure}

<!--Supp. FIG : Hassell model, local dispersal-->
\begin{figure}[!h]
\begin{center}
\includegraphics[width=12 cm]{./Results/common_legend.pdf}\\
\includegraphics[width=12 cm]{./Results/hassell_scl_1/hassell_ext_risk_local_disp.pdf}\\
...
numsims=10000, $\sigma$=1. \label{fig_hassell_risk_local_disp_scl_1}}
\end{center}
\end{figure}

<!--Supp. FIG : Maynard smith model, local dispersal-->
\begin{figure}[!h]
\begin{center}
\includegraphics[width=12 cm]{./Results/common_legend.pdf}\\
\includegraphics[width=12 cm]{./Results/msmith_scl_0.8/msmith_ext_risk_local_disp.pdf}\\
...
numsims=10000, $\sigma$=0.8. \label{fig_msmith_risk_local_disp_scl_0.8}}
\end{center}
\end{figure}

<!--Supp. FIG : Pennycuick model, local dispersal-->
\begin{figure}[!h]
\begin{center}
\includegraphics[width=12 cm]{./Results/common_legend.pdf}\\
\includegraphics[width=12 cm]{./Results/pennycuick_scl_1/pennycuick_ext_risk_local_disp.pdf}\\
...
numsims=10000, $\sigma$=1. \label{fig_risk_local_disp_pennycuick_r_vary_scl_1}}
\end{center}
\end{figure}

<!--Supp. FIG : Verhulst model, local dispersal-->
\begin{figure}[!h]
\begin{center}
\includegraphics[width=12 cm]{./Results/common_legend.pdf}\\
\includegraphics[width=12 cm]{./Results/verhulst_scl_0.6/verhulst_ext_risk_local_disp.pdf}\\
...
numsims=10000, $\sigma$=0.6. \label{fig_risk_local_disp_verhulst_r_vary_scl_0.6}}
\end{center}
\end{figure}

<!--Supp. FIG : Austin-Brewer model, local dispersal-->
\begin{figure}[!h]
\begin{center}
\includegraphics[width=12 cm]{./Results/common_legend.pdf}\\
\includegraphics[width=12 cm]{./Results/austinbrewer_scl_0.6/abrewer_ext_risk_local_disp.pdf}\\
...
numsims=10000, $\sigma$=0.6. \label{fig_risk_local_disp_abrewer_r_vary_scl_0.6}}
\end{center}
\end{figure}

<!--Supp. FIG : Ricker model, global dispersal-->
\begin{figure}[!h]
\begin{center}
\includegraphics[width=12 cm]{./Results/common_legend.pdf}\\
\includegraphics[width=12 cm]{./Results/ricker_scl_1/ricker_ext_risk_global_disp.pdf}\\
...
numsims=10000, $\sigma$=1. \label{fig_ricker_risk_global_disp_scl_1}}
\end{center}
\end{figure}

<!--Supp. FIG : Hassell model, global dispersal-->
\begin{figure}[!h]
\begin{center}
\includegraphics[width=12 cm]{./Results/common_legend.pdf}\\
\includegraphics[width=12 cm]{./Results/hassell_scl_1/hassell_ext_risk_global_disp.pdf}\\
...
numsims=10000, $\sigma$=1. \label{fig_hassell_risk_global_disp_scl_1}}
\end{center}
\end{figure}

<!--Supp. FIG : Maynard smith model, global dispersal-->
\begin{figure}[!h]
\begin{center}
\includegraphics[width=12 cm]{./Results/common_legend.pdf}\\
\includegraphics[width=12 cm]{./Results/msmith_scl_0.8/msmith_ext_risk_global_disp.pdf}\\
...
numsims=10000, $\sigma$=0.8. \label{fig_msmith_risk_global_disp_scl_0.8}}
\end{center}
\end{figure}

<!--Supp. FIG : Pennycuick model, global dispersal-->
\begin{figure}[!h]
\begin{center}
\includegraphics[width=12 cm]{./Results/common_legend.pdf}\\
\includegraphics[width=12 cm]{./Results/pennycuick_scl_1/pennycuick_ext_risk_global_disp.pdf}\\
...
numsims=10000, $\sigma$=1. \label{fig_risk_global_disp_pennycuick_r_vary_scl_1}}
\end{center}
\end{figure}

<!--Supp. FIG : Verhulst model, global dispersal-->
\begin{figure}[!h]
\begin{center}
\includegraphics[width=12 cm]{./Results/common_legend.pdf}\\
\includegraphics[width=12 cm]{./Results/verhulst_scl_0.6/verhulst_ext_risk_global_disp.pdf}\\
...
numsims=10000, $\sigma$=0.6. \label{fig_risk_global_disp_verhulst_r_vary_scl_0.6}}
\end{center}
\end{figure}

<!--Supp. FIG : Austin brewer model, global dispersal-->
\begin{figure}[!h]
\begin{center}
\includegraphics[width=12 cm]{./Results/common_legend.pdf}\\
\includegraphics[width=12 cm]{./Results/austinbrewer_scl_0.6/abrewer_ext_risk_global_disp.pdf}\\
...
numsims=10000, $\sigma$=0.6. \label{fig_risk_global_disp_abrewer_r_vary_scl_0.6}}
\end{center}
\end{figure}
...
standard-normal random draws (in general), where $N = numsteps(=25) \times numsims(=10000)$.
Then, each row of
M was identified for a first set of modifications
