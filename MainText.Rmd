...
\vspace{12pt}
\noindent \textbf{\textit{Keywords:}} extinction risk, extreme events, tail association, density-dependent model, copula, mathematical ecology
...
will still be and appropriate and important quantity to study 
...
ecological impact of $X_i$ and $X_j$ will be a nonlinear or unknown monotonic functions of 
...
then be traded off against increases/reductions (respectively) in either 
...
by @walteretal2017, have explored geographic variation in the synchrony of environmental
and population variables; @walteretal2017 explored the mechanisms, consequences
and ecological importance of the geography of synchrony. For instance, synchrony was found to 
have a prominent geography which can help provide inferences about the causes
