...
and our essential goal is to advance the idea that tail associations may
...
to subsequently crash, across all or most habitat patches. In contrast 
...
and intensity, linked to changes in the distribution of $X_i(t)$ such as changes
...
changing. However, documented changes in correlation between $X_i(t)$ and $X_j(t)$
...
variables, rather than reflecting true changes in association (these studies
...
goal is to understand associations between variables, including how such 
...
(A, B) and extreme (C, D) asymmetry of tail association. The solid line is the estimated extinction risk, and the area of shading, which is barely visible because it is very narrow, shows 95\% confidence intervals for extinction risk. LT=left tail, RT=right tail.\label{fig_extrisk_agestr}}
\end{center}
\end{figure*}
