...
<!--Background for extinction risk in ecological model-->
...
left-tail dependent than the one if noises came with right-tail dependence) holds true only in
...
To examine (Q3), we evaluated extinction risk for each metapopulation model for a wide 
