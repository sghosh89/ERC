...
one-patch, deterministic version of the model, Table \ref{tab_model_summary}).
...
we estimated extinction risk of each model using each form of tail 
association in the environmental noise,
across the range of $r$ indicated above that spanned under- and overcompensatory dynamics.
We chose equispaced values of $r$ from the 95\% quantiles 
...
```
<!--***DAN: Shyamolina, can you please make the header of the second column read simply \lambda_i(t)?-->
