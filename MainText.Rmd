...
risk for the metapopulations. All models were consistent with our prediction (see Q2 from \nameref{intro}) 
across local and global dispersal (Figs. \ref{fig_extrisk_allmodel_localdisp} and 
\ref{SM-fig_extrisk_allmodel_globaldisp}). 
