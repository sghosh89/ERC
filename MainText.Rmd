...
importance for extinction risk. However, our results provide suggestive, rather
than definitive evidence, here, because we considered 
only one model. In our stage-structured, non-spatial model, extinction 
...
some event categories and specific events can now be attributed with confidence to
...
extinction risk through the mechansms that were explored in this paper. 
...
<!--***DAN: Dan to elaborate and make more specific/precise-->
...
approximation of extinction risk of Lande and Orzack looking at tail associations? Maybe
this and the previous para need to be combined, or broken up in a different way.-->
...
dependencies with copula could help in this case. 
<!--***DAN: the ideas in this para up to here (taking out the wrong statements) might 
follow on well from a para based on the notes I wrote above on Tulja's approx.-->
Second, we did not consider multiple sites of 
...
with spatially correlated extreme climatic events. 
<!--***DAN: a reasonable point, above-->
Third, we considered the tail association 
...
<!--***DAN: mentioning interactions strikes me as a step too far-->
An earlier study [@carnicer2011widespread] showed extreme events
...
a lot more potential to estimate the risk of cascading extinction in model food webs. <!--should I 
mention about 
...
<!--***DAN: might also mention how this relates with geog of sync of environmental vars, linking to
Jon's paper-->
