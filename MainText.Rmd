...
copula was used to estimate extinction risk. Copula, a rank based measure, is much more informative 
than linear correlation measure and a widely applied tool in dependence 
modeling [@joe2014_dependence; @nelsen2006_copula]. We will hereby illaborate the idea why
the potential use of copula in modelling extinction risk goes beyond the density-independent model 
and even applicable for a simple age-structured population where its vital rates are influenced by ECEs. 
<!--do I need to explain the details how to make a copula from raw data?-->
