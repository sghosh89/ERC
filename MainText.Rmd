...
\end{center}
\end{figure*}
<!--***DAN: Shyamolina, please change the u and v axis labels on the figure
to x and y, respectively, since we defined those as the ranks in the main text.
***Shya: Done.-->
...
***DAN: I wrote it guessing that that was what you did. If that is not what you did,
when we should discuss, preferably as soon as possible, before Friday.
...
***DAN: I added some comments above the function extrisk in mydispersal.R, after reading those
can you tell me by adding another comment what you did and if what I wrote here was correct?
***Shya: Yes, you are correct. I also added commented text in mydispersal.R lines 153-165. Have a look 
to check that you are agreed with me or not.
-->
...
<!--***DAN: stopped here, also need to do the caption of the last figure-->
...
Extinction risks are for a 25-year time horizon. \label{fig_extrisk_allmodel_localdisp}}
\end{center}
\end{figure*}
