...
to extreme - using "copula" (for details see @Ghosh_copula and \nameref{Methods}), a statistical 
tool generally used to model dependencies between correlated variables. 
...
are more vulnerable to "catastrophs" (extreme bad years) than to "bonanzas" (extreme good years).
...
the density-dependent metapopulation patches which experience same spatially correlated noise but having a variety of tail asymmetry (from extreme to moderate, Fig. \ref{fig_intro_cop}). It is expected that extreme left-tail associated noise might wipe out some metapopulation patches 
...
thereby inflate the population viability. 


Similarly, in context of 
