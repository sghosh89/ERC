...
what are the implication of extreme events on life history? 
any negative or positive effects? : past literatures-->
For past few decades, there have been evidences that anthropogenic climate change 
is causing more frequent extreme events [ref] (e.g. temperature or precipitation extremes,
heat-waves, wild-fire) which show shifts in its mean, 
in the variability of the distribution, as well as changes in its 
symmetry or skewness. Such extreme climatic events (ECE) can pose severe
impacts at the individual, population, community and ecosystem level (e.g. Parmesan,
Root & Willig 2000; van de Pol et al. 2010b; Hoover,
Knapp & Smith 2014). Therefore, understanding the long-term impacts of changes 
in ECEs has been a longstanding interest in ecological research, specically in modelling 
extreme-risks [ref:Risk Analysis, Vol. 32, No. 11, 2012]. 
