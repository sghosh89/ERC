...
value of $r$. Figs. \ref{fig_extrisk_allmodel_localdisp} shows
...
\caption{Extinction risk against time from single patch age structured linear ($\Omega = \infty$) $(A, C)$ and nonlinear ($\Omega = 100$) $(C, D)$ models for $10000$ simulations; shading represents 95\% confidence interval. $(A, B)$ show extinction risk with time when fecundity of adults and survival of eggs have extreme left tail (LT) or extreme right tail (RT) association, $(C, D)$ show the analogous scenario but with moderate tail association between vital rates. \label{fig_extrisk_agestr}}
\end{center}
\end{figure*}
