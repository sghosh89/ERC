...
numsims<-10000
ricker_extrisk_d0$CI0.025left<-qbinom(ricker_extrisk_d0$risk_left_d0,size=numsims,prob=0.025)/numsims
ricker_extrisk_d0$CI0.975left<-qbinom(ricker_extrisk_d0$risk_left_d0,size=numsims,prob=0.975)/numsims

ricker_extrisk_d0$CI0.025right<-qbinom(ricker_extrisk_d0$risk_right_d0,size=numsims,prob=0.025)/numsims
ricker_extrisk_d0$CI0.975right<-qbinom(ricker_extrisk_d0$risk_right_d0,size=numsims,prob=0.975)/numsims
...
arrows(x0=ricker_extrisk_d0$r,y0=ricker_extrisk_d0$CI0.025left,x1=ricker_extrisk_d0$r,y1=ricker_extrisk_d0$CI0.975left,angle=90,length=0.05,col=rgb(1,0,0,0.5),code=3)

lines(ricker_extrisk_d0$r,ricker_extrisk_d0$risk_right_d0,col="blue",type="b",ylim=c(0,1),pch=1)
arrows(x0=ricker_extrisk_d0$r,y0=ricker_extrisk_d0$CI0.025right,x1=ricker_extrisk_d0$r,y1=ricker_extrisk_d0$CI0.975right,angle=90,length=0.05,col=rgb(0,0,1,0.5),code=3)
...
hassell_extrisk_d0$CI0.025left<-qbinom(hassell_extrisk_d0$risk_left_d0,size=numsims,prob=0.025)/numsims
hassell_extrisk_d0$CI0.975left<-qbinom(hassell_extrisk_d0$risk_left_d0,size=numsims,prob=0.975)/numsims

hassell_extrisk_d0$CI0.025right<-qbinom(hassell_extrisk_d0$risk_right_d0,size=numsims,prob=0.025)/numsims
hassell_extrisk_d0$CI0.975right<-qbinom(hassell_extrisk_d0$risk_right_d0,size=numsims,prob=0.975)/numsims
...
arrows(x0=hassell_extrisk_d0$r,y0=hassell_extrisk_d0$CI0.025left,x1=hassell_extrisk_d0$r,y1=hassell_extrisk_d0$CI0.975left,angle=90,length=0.05,col=rgb(1,0,0,0.5),code=3)

lines(hassell_extrisk_d0$r,hassell_extrisk_d0$risk_right_d0,col="blue",type="b",ylim=c(0,1),pch=1)
arrows(x0=hassell_extrisk_d0$r,y0=hassell_extrisk_d0$CI0.025right,x1=hassell_extrisk_d0$r,y1=hassell_extrisk_d0$CI0.975right,angle=90,length=0.05,col=rgb(0,0,1,0.5),code=3)
mtext(paste0("d = 0 , numsims = ",numsims),side=3,line=0.2)
...
set.seed(seed)
numsims<-10000
msmith_extrisk_d0<-readRDS("./Results/msmith/msmith_extrisk_d0.RDS")

msmith_extrisk_d0$CI0.025left<-qbinom(msmith_extrisk_d0$risk_left_d0,size=numsims,prob=0.025)/numsims
msmith_extrisk_d0$CI0.975left<-qbinom(msmith_extrisk_d0$risk_left_d0,size=numsims,prob=0.975)/numsims

msmith_extrisk_d0$CI0.025right<-qbinom(msmith_extrisk_d0$risk_right_d0,size=numsims,prob=0.025)/numsims
msmith_extrisk_d0$CI0.975right<-qbinom(msmith_extrisk_d0$risk_right_d0,size=numsims,prob=0.975)/numsims

pdf("./Results/msmith/msmith_extrisk_d0.pdf",height = 6,width=6)
...
arrows(x0=msmith_extrisk_d0$r,y0=msmith_extrisk_d0$CI0.025left,x1=msmith_extrisk_d0$r,y1=msmith_extrisk_d0$CI0.975left,angle=90,length=0.05,col=rgb(1,0,0,0.5),code=3)

lines(msmith_extrisk_d0$r,msmith_extrisk_d0$risk_right_d0,col="blue",type="b",ylim=c(0,1),pch=1)
arrows(x0=msmith_extrisk_d0$r,y0=msmith_extrisk_d0$CI0.025right,x1=msmith_extrisk_d0$r,y1=msmith_extrisk_d0$CI0.975right,angle=90,length=0.05,col=rgb(0,0,1,0.5),code=3)
mtext(paste0("d = 0 , numsims = ",numsims),side=3,line=0.2)
...
![Effect of non-Normal environmental noise copula on extinction risk after 25 years (Maynard Smith model : a = 1, b = 3, rc = 4/3) with local dispersion; numlocs=5, numsteps=25, numsims=10000\label{fig_risk_local_disp_msmith_r_vary}](./Results/msmith/msmith_ext_risk_local_disp.pdf){ width=40%, height=40% }

![Effect of non-Normal environmental noise copula on extinction risk after 25 years (Maynard Smith model : a = 1, b = 3, rc = 4/3) with global dispersion; numlocs=5, numsteps=25, numsims=10000\label{fig_risk_global_disp_msmith_r_vary}](./Results/msmith/msmith_ext_risk_global_disp.pdf){ width=40%, height=40% }

![Effect of non-Normal environmental noise copula on extinction risk after 25 years (Maynard Smith model with no dispersion : rc=1.33); numlocs=5, numsteps=25, numsims=10000\label{fig_msmith_risk_d0}](./Results/msmith/msmith_extrisk_d0.pdf){ width=40%, height=40% }
...
![Effect of non-Normal environmental noise copula on extinction risk after 25 years (Pennycuick model : a = 1, b = 3) with global dispersion; numlocs=5, numsteps=25, numsims=10000\label{fig_risk_global_disp_msmith_r_vary}](./Results/pennycuick/pennycuick_ext_risk_global_disp.pdf){ width=40%, height=40% }
