...
for(i in c(1:length(rlist))){
    ...
    temp_mat<-cbind(s$d_seq,s$risk_left,s$risk_right,s$pop_avg_acf_left,s$pop_avg_acf_right,s$noise_avg_acf_left,s$noise_avg_acf_right)
...
cnm<-c("d","risk_left","risk_right","pop_avg_acf_left","pop_avg_acf_right","noise_avg_acf_left","noise_avg_acf_right")
...
for(i in 1:dim(res_ricker_local)[3]){
  ...
  lines(s$d, s$noise_avg_acf_left, col="green")
