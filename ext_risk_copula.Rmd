...
qrng<-runif(10000,min=1,max=r_bf_hassell) # r must be > 1
qr<-quantile(qrng,probs=c(.025,.975))
...
plot(hassell_extrisk_d0$r,hassell_extrisk_d0$risk_left_d0,col="red",type="b",ylim=c(0,1),xlim = range(rlist),
...
qrng<-runif(10000,min=1,max=r_bf_msmith) #r must be > 1 for +ve eqm pt.
qr<-quantile(qrng,probs=c(.025,.975))
...
qrng<-runif(10000,min=1,max=r_bf_pennycuick) # r must be > 1
qr<-quantile(qrng,probs=c(.025,.975))
